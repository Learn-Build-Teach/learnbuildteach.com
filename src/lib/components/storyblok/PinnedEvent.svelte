...
>
	...
	/>
	<div class="px-4 md:px-8 z-0" use:storyblokEditable={blok}>
		...
		<div class="flex flex-col md:flex-row gap-4">
			<a
				...
				class="bg-white border-none block max-w-max py-2 px-4 md:mb-4 rounded-lg text-primary hover:bg-accent transition-500"
			>
				{blok.cta_title}
			</a>
