...
<div class="flex flex-col justify-start mt-12">
	<a href={postContent.link}>
		...
		/>
		<h2 class="text-slate-200 text-lg font-semibold leading-[23px] mt-4">{postContent.title}</h2>
	</a>
	<span class="text-slate-300 text-[11px] font-normal mt-2">{postContent.pubDate}</span>
</div>
